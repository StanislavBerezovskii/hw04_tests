# Generated by Django 2.2.16 on 2022-09-20 20:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='follow',
            constraint=models.UniqueConstraint(fields=('user', 'author'), name='Повторная подписка невозможна!'),
        ),
    ]
