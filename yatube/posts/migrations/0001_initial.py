# Generated by Django 2.2.16 on 2022-09-19 13:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Введите URL-адрес группы', unique=True, verbose_name='URL-Адрес')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(blank=True, help_text='Укажите группу для поста', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posts', to='posts.Group', verbose_name='Группа, к которой будет относиться пост')),
            ],
            options={
                'verbose_name': 'Пост',
